...
_ALWAYS_SAFE = frozenset(bytes(b"ABCDEFGHIJKLMNOPQRSTUVWXYZ" b"abcdefghijklmnopqrstuvwxyz" b"0123456789" b"_.-"))
...
def urlencode(query, doseq=False, safe="", encoding=None, errors=None):
    ...
    if hasattr(query, "items"):
        ...
        try:
            ...
            raise_with_traceback(TypeError("not a valid non-string sequence " "or mapping object"), tb)
