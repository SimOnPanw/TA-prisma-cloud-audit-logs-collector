            ...
            if not request.has_header("Content-length"):
                ...
                try:
                    ...
                    if isinstance(data, Iterable):
                        raise ValueError(
                            "Content-Length should be specified " "for iterable data of type %r %r" % (type(data), data)
                        )
                else:
        ...
        if FileHandler.names is None:
            try:
                FileHandler.names = tuple(
                    socket.gethostbyname_ex("localhost")[2] + socket.gethostbyname_ex(socket.gethostname())[2]
                )
