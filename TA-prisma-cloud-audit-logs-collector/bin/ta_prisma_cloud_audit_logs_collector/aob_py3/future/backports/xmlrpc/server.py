...
class MultiPathXMLRPCServer(SimpleXMLRPCServer):
    ...
    def __init__(
        ...
        SimpleXMLRPCServer.__init__(
            self, addr, requestHandler, logRequests, allow_none, encoding, bind_and_activate, use_builtin_types
        )
        self.dispatchers = {}
        self.allow_none = allow_none
        self.encoding = encoding or "utf-8"
...
class ServerHTMLDoc(pydoc.HTMLDoc):
    ...
    def markup(self, text, escape=None, funcs={}, classes={}, methods={}):
        ...
        pattern = re.compile(r"\b((http|ftp)://\S+[\w/]|" r"RFC[- ]?(\d+)|" r"PEP[- ]?(\d+)|" r"(self\.)?((?:\w|\.)+))\b")
        while 1:
    ...
    def docroutine(self, object, name, mod=None, funcs={}, classes={}, methods={}, cl=None):
        ...
        if inspect.ismethod(object):
            ...
            args = inspect.getfullargspec(object)
            argspec = inspect.formatargspec(
                args.args, args.varargs, args.varkw, args.defaults, annotations=args.annotations, formatvalue=self.formatvalue
            )
        else:
            argspec = "(...)"
