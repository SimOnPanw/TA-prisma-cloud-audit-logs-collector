...
class Command(object):
    ...
    def __init__(self, parser=None):
        self.parser = parser or argparse.ArgumentParser(description=self.description, epilog=self.epilog)
...
def get_parser():
    ...
    subparsers = parser.add_subparsers(help="choose one of these actions", dest="action", metavar="<action>")
    ...
    for name, command_class in sorted(cmds):
        ...
        subparser = subparsers.add_parser(
            name, help=help, description=description, epilog=epilog, formatter_class=argparse.RawDescriptionHelpFormatter
        )  # noqa
