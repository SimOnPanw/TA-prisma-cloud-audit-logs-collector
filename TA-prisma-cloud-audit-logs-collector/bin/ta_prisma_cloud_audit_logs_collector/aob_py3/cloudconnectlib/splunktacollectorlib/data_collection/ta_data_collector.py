...
event_tuple = namedtuple("Event", ["host", "source", "sourcetype", "time", "index", "raw_data", "is_unbroken", "is_done"])


class TADataCollector(object):
    def __init__(self, tconfig, meta_config, task_config, checkpoint_manager_cls, data_client_cls, data_loader):
    ...
    def _create_data_client(self):
        return self.data_client_cls(
            self._meta_config, self._task_config, self._checkpoint_manager, self._data_loader.get_event_writer()
        )
