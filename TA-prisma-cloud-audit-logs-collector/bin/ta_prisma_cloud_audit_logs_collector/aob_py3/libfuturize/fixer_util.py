...
def touch_import_top(package, name_to_import, node):
    ...
    if package is None:
        import_ = Node(syms.import_name, [Leaf(token.NAME, "import"), Leaf(token.NAME, name_to_import, prefix=" ")])
    else:
                ...
                [
                    Node(
                        ...
                        [
                            ...
                            Node(syms.trailer, [Leaf(token.DOT, "."), Leaf(token.NAME, "install_aliases")]),
                            Node(syms.trailer, [Leaf(token.LPAR, "("), Leaf(token.RPAR, ")")]),
                        ],
                    )
                ],
            )
