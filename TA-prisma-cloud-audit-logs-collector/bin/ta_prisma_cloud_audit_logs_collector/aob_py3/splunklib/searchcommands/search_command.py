...
class SearchCommand(object):
    ...
    _metadata_map = {
        ...
        "searchinfo": {
            ...
            "latest_time": (lambda v: float(v.rt_latest) if len(v.rt_latest) > 0 else 0.0, lambda s: s.search_results_info),
            "owner": (None, None),
    ...
    class ConfigurationSettings(object):
        ...
        def __str__(self):
            ...
            text = ", ".join(
                ["{}={}".format(name, json_encode_string(six.text_type(value))) for (name, value) in six.iteritems(self)]
            )
            return text
