        ...
        try:
            ...
            if he.status == 401 and self.autologin:
                ...
                with _handle_auth_error(
                    "Autologin succeeded, but there was an auth error on " "next request. Something is very wrong."
                ):
                    return request_fun(self, *args, **kwargs)
...
class Context(object):
    ...
    **Example**::
    ...
    def __init__(self, handler=None, **kwargs):
        self.http = HttpLib(
            handler, kwargs.get("verify", False), key_file=kwargs.get("key_file"), cert_file=kwargs.get("cert_file")
