...
def _check_generic(cls, parameters):
    ...
    if alen != elen:
        raise TypeError(
            "Too %s parameters for %s; actual %s, expected %s" % ("many" if alen > elen else "few", repr(cls), alen, elen)
        )
...
if hasattr(typing, "DefaultDict"):
    ...
    class DefaultDict(
        collections.defaultdict, typing.MutableMapping[KT, VT], metaclass=_ExtensionsGenericMeta, extra=collections.defaultdict
    ):
...
if hasattr(typing, "OrderedDict"):
    ...
    class OrderedDict(
        collections.OrderedDict, typing.MutableMapping[KT, VT], metaclass=_ExtensionsGenericMeta, extra=collections.OrderedDict
    ):
...
if hasattr(typing, "ChainMap"):
    ...
    if _geqv_defined:
        ...
        class ChainMap(
            collections.ChainMap, typing.MutableMapping[KT, VT], metaclass=_ExtensionsGenericMeta, extra=collections.ChainMap
        ):
...
if hasattr(typing, "Protocol"):
    ...
    class _ProtocolMeta(abc.ABCMeta):
        ...
        def __instancecheck__(cls, instance):
            ...
            if cls._is_protocol:
                if all(
                    hasattr(instance, attr) and (not callable(getattr(cls, attr, None)) or getattr(instance, attr) is not None)
                    for attr in _get_protocol_attrs(cls)
                ):
                    return True
    ...
    def _typeddict_new(*args, total=True, **kwargs):
        ...
        if args:
            try:
                ...
                raise TypeError(
                    "TypedDict.__new__() takes from 2 to 3 " "positional arguments but {} " "were given".format(len(args) + 2)
                )
...
if hasattr(typing, "TypeGuard"):
    ...
    class _TypeGuard(typing._FinalTypingBase, _root=True):
        ...
        def __getitem__(self, item):
            cls = type(self)
            if self.__type__ is None:
                return cls(typing._type_check(item, "{} accepts only a single type.".format(cls.__name__[1:])), _root=True)
            raise TypeError("{} cannot be further subscripted".format(cls.__name__[1:]))
