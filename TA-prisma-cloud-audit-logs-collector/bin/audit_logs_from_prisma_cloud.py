...
class ModInputaudit_logs_from_prisma_cloud(modinput_wrapper.base_modinput.BaseModInput):
    def __init__(self):
        ...
        super(ModInputaudit_logs_from_prisma_cloud, self).__init__(
            "ta_prisma_cloud_audit_logs_collector", "audit_logs_from_prisma_cloud", use_single_instance
        )
    ...
    def get_scheme(self):
        ...
        """
        scheme.add_argument(
            smi.Argument("base_url", title="Base URL", description="", required_on_create=True, required_on_edit=False)
        )
        scheme.add_argument(
            smi.Argument(
                "access_key",
